...
const FieldLabel: React.FC<LabelProps> = (props: LabelProps) => {
  return (
    <div className="fieldLabel">
      <label className="fieldLabelTitle" htmlFor={props.name} id={props.id}>
...
function ChangeAddress() {
  const changeAddressSchema = Yup.object().shape({
    ...
    addressLine2: Yup.string().required(REQUIRED_FIELD_ERROR),
    ...
    <div>
      <section>
        <Formik
          ...
          onSubmit={(
            values: ChangeAddressValues,
            { setSubmitting }: FormikHelpers<ChangeAddressValues>
          ) => {
            setTimeout(() => {
              console.log(values);
              // addHacker(values, user); user var is firebase user. Just get it from auth()

              // TODO: IMPLEMENT Firestore field changes.
              setSubmitting(false);
            }, 500);
          }}
        >
              ...
              <EmojiProvider>
                ...
                <div className="fieldWrapper">
                  ...
                  {errors.addressLine1 && touched.addressLine1 ? (
                    <div className="errors">{errors.addressLine1}</div>
                  ) : null}
                </div>
