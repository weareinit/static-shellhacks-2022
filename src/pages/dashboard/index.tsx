...
function Dashboard() {
  ...
  const { apartment, city, country, postalCode, state, streetAddress } = address || {};
          ...
          <div className={styles.dashboardWrapper}>
            <div className={styles.sidebar}>
              ...
              <SidebarItem title="Application Status">
                <p className={`${styles.sidebarText} ${styles.applicationStatus}`}>
                  APPLIED!
                  {
              ...
              <SidebarItem title="Hacker Guide">
                <p className={styles.sidebarText}>COMING SOON</p>
              </SidebarItem>
              ...
              <SidebarItem title="Contact Us">
                <ul className={styles.sidebarList}>
                  <li>
                    <a className={styles.link} href="https://discord.gg/upefiu">
                      Discord
                    </a>
                  </li>
                  <li>
                    <a className={styles.link} href="mailto:Upe@fiu.edu?subject=ShellHacks 2022 Participant Inquiry">
                      E-Mail
                    </a>
                  </li>
                </ul>
              ...
              <div className={`${styles.logoutButtonBackground} ${styles.logout}`}>
                <button
              ...
              <div className="information-view">
                ...
                <div className={styles.applicationField}>
                  <div className="address-information">
                    <p>Address:</p>
                    <p className={styles.applicationFieldText}>
                      {streetAddress} {apartment} {postalCode} {city}, {state} {country}
                    </p>
                  </div>
                  <button
                ...
                <div className={styles.applicationField}>
                  <p>T-Shirt Size:</p>
                  <p className={styles.applicationFieldText}>{shirtSize}</p>
                </div>
                {
                  // <Resume></Resume>
                }
