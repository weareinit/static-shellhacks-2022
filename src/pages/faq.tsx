...
const FAQS = [
    ...
    ["How long is it?", "ShellHacks is a 36-hour hackathon, beginning at 4pm on Friday and ending at 3pm on Sunday. We encourage you to work on your project for as long as you can during this time."],
    ["Who can come?", "If you’re currently a college student or have graduated in the past year, you're more than welcome to attend! Not a student? No problem! You can attend as a mentor and help out our students! Mentor applications are available here."],
        ...
        <div className={styles.mainContent}>
            ...
            <div>
                ...
                <ul>
                    {FAQS.map((f) => {
                        return (
                            <SingleFAQ key={f[0]} question={f[0]}>
                                {f[1]}
                            </SingleFAQ>
                        );
                    })}
