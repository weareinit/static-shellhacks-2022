...
export async function sendConfirmationEmail(
    ...
    const data = {
        ...
        message: {
            ...
            Let everyone know you're excited for ShellHacks! Follow us on Instagram at https://www.instagram.com/upefiu and make a post or story tagging @upefiu using the hashtag #ShellHacks and please also keep an eye on our social media @upefiu for any future updates!
            ...
            <p><b>3️⃣ Follow us on Instagram</b></p>
            <p>Let everyone know you're excited for ShellHacks! Follow us on <a href="https://www.instagram.com/upefiu" target="_blank" rel="noopener noreferrer">Instagram</a> and make a post or story tagging @upefiu using the hashtag #ShellHacks and please also keep an eye on our social media @upefiu for any future updates!</p>
            <br>
            <p>With ❤️,</p>
