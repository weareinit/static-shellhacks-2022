...
import getSignUp from "../../pages/api/signup";
...
const SignUpForm: React.FC = () => {
  ...
  const signUp = async (event: any) => {
    ...
    getSignUp({ email, password }).catch((e: FirebaseError) => {
      console.log(e.code);
    ...
    <form>
      ...
      <div className={styles.buttonDiv}>
        <div className={styles.submitButtonBackground}>
          <input className={styles.submitButton} type="submit" value="Sign Up" id="signup" onClick={signUp} />
        </div>
      </div>
    </form>
  );
