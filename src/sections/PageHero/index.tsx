  ...
  return (
    <section className="pageHeroBackground">
      <div className="pageHeroTop">
        <img alt="ShellHacks Logo" className="pageHeroLogo" src={ShellHacks} />
      ...
      <div className="pageHeroMiddle">
        ...
        <div className="buttonsDiv">
          ...
          <div className="buttonsRow">
            <LinkButton text="Discord" url="https://discord.gg/upefiu" />
            <LinkButton text="Sponsor Us" url="mailto:Upe@fiu.edu?subject=We want to sponsor" />
          </div>
        </div>
      </div>
    </section>
